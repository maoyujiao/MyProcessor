...
public class Consts {
    ...
    public static final String TYPE_ROUTER = "com.aiyuba.route_annotation.Route";
    public static final String TYPE_EXTRA = "com.aiyuba.route_annotation.Extra";
    public static String ACTIVITY = "android.app.Activity";

    public static final String ISERVICE = "com.aiyuba.route_annotation.template.IService";

    public static final String IROUTE_GROUP = "com.aiyuba.route_annotation.template.IRouteGroup";
    public static final String IROUTE_ROOT = "com.aiyuba.route_annotation.template.IRouteRoot";
    public static final String IEXTRA = "com.aiyuba.route_annotation.template.IExtra";

    public static final String METHOD_LOAD_INTO = "loadInto";
    public static final String METHOD_LOAD_EXTRA = "loadExtra";

    public static final String SEPARATOR = "$$";
    public static final String PROJECT = "Myj";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.aiyuba.route_core";

...
import com.aiyuba.route_annotation.template.IRouteRoot;
import com.aiyuba.route_annotation.template.IService;
import com.aiyuba.route_core.callback.NavigationCallback;
import com.aiyuba.route_core.exception.NoRouteFoundException;
import com.aiyuba.route_core.utils.ClassUtils;
...
public class DNRouter {
    ...
    private static final String ROUTE_ROOT_PAKCAGE = "com.aiyuba.route_core";
    private static final String SDK_NAME = "Myj";
...
//        }
    ...
    protected Object navigation(Context context, final Postcard postcard, final int requestCode,
        ...
        switch (postcard.getType()) {
            case ACTIVITY:
                ...
                final Intent intent = new Intent(currentContext, postcard.getDestinaation());
    ...
    private void prepareCard(Postcard card) {
        ...
        if (null == routeMeta) {
            ...
            card.setDestinaation(routeMeta.getDestinaation());
            card.setType(routeMeta.getType());
            switch (routeMeta.getType()) {
                case ISERVICE:
                    Class<?> destination = routeMeta.getDestinaation();
